 ...
 * BadgeCard component.
 *
 * @param data Datos para las bandas @see DataItemBadge
 * @param length Longitud de las bandas por defecto 4
 * @param descriptionLength Longitud de la descripción por defecto 10
 *
 * @returns
 */
const BadgeCard = ({
    ...
    >
      {data.map((item, index) => (
        <Badge
          key={index}
          size="3"
          color={alertColor({ alert: mapStatusToAlert(item.status) })}
        >
 ...
 *
 * @param title Texto para el titulo
 * @param description Texto para la descripción, con formato html (<strong>, <br>, <h1>, etc)
 * @param descriptionLength Longitud de la descripción por defecto 10
 * @param alert Alerta para el color @see Alerts
 *
 * @returns
 */
 ...
 *
 * @param title Texto para el titulo
 * @param description Texto para la descripción
 * @param descriptionLength Longitud de la descripción por defecto 80
 * @param firtsColor Color de fondo distinto
 * @param onClick Evento al hacer click
 * @param cardIcon Icono para el card
 * @param infoChildren Información adicional
 *
 * @returns
 */
const CardGrid = ({
  ...
  return (
    <Card
      size="2"
      onClick={onClick}
      style={{ cursor: "pointer", backgroundColor: colorBackground }}
    >
