 ...
 * @param justify Justificación del texto
 * @param direction Dirección de la presentación (horizontal o vertical)
 * @param width Ancho de la presentación (opcional)
 *
 * @returns
 */
 ...
 * @returns
 */
const useCalculatePresentation = (
