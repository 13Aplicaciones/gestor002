...
import { Alerts, TextFormat, SortColumn } from '../../ConstantsPresentation';
                ...
                <DropdownMenu.Root>
                    <DropdownMenu.Trigger>
                        <IconButton
                            ...
                            {presentation[index].order === SortColumn.asc &&
                                <CaretUpIcon />
                            }
                            {presentation[index].order === SortColumn.desc &&
                                <CaretDownIcon />
                            }
                            {presentation[index].order === SortColumn.neutral &&
                                <CaretSortIcon />
                            }
                            <Text size="2" weight="bold">
                                {text}
