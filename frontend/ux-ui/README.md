...
El UX-UI es una librería que contiene elementos de UX-UI para mostrar la información obtenida así como elementos comunes de una aplicación web para 13 Aplicaciones.
...
A grandes rasgos, la configuración de la librería UX-UI es sencilla, solo se necesita instalar la librería y configurarla en el archivo principal de la aplicación, por lo que se explica las más importantes.
...
**Para instalar** la librería UX-UI se debe ejecutar el siguiente comando:

```bash
npm install
```

**Para ejecutar** la librería UX-UI se debe ejecutar el siguiente comando:
...
**Para construir** la librería UX-UI se debe ejecutar el siguiente comando:

```bash
npm run build
```

**Para limpiar** la librería UX-UI se debe ejecutar el siguiente comando:
...
Para instalar la librería UX-UI en las aplicaciones que se están desarrollando, se debe ejecutar los siguientes comandos, y debe estar la carpeta *${WORK_PATH}/ux-ui/dist*
