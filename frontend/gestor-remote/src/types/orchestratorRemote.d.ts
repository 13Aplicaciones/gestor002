...
declare module 'orchestrator_remote/service/Parameter' {
  ...
  export function refreshParameter(indexParameter:string): Promise<any>;
  export type IParameter = IParameter; 
}


declare module 'orchestrator_remote/service/UserDefineCode' {
  export const parameterService: ParameterService;
  export function getUserDefinedCodes(indexModule:string): Promise<any>;
  export function getUserDefinedCodeByGroup(indexModule:string, group:string): Promise<any>;
  export function refreshUserDefinedCode(indexParameter:string): Promise<any>;
  export type IUserDefinedCode = IUserDefinedCode; 
}