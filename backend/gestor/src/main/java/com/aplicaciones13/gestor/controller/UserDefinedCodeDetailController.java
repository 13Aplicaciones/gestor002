...
import com.aplicaciones13.gestor.services.UserDefinedCodeDetailService;

import io.swagger.v3.oas.annotations.tags.Tag;

@RestController
@RequestMapping("/api/cduDetail")
@Tag(name = "Codigo Definido User - Detalle", description = "Servicio para CRUD de Codigos Definidos por el user (CDU) Detalle")
public class UserDefinedCodeDetailController {

    @Autowired
    private UserDefinedCodeDetailService userDefinedCodeDetailService;
